阿里云上的 MySQL RDS WordPress 解决方案 Terraform 模块
...
以下示例展示如何使用 MySQL RDS 创建完整的 WordPress 托管环境：
...
* [完整示例](https://github.com/alibabacloud-automation/terraform-alicloud-mysql-rds-wordpress/tree/main/examples/complete)
